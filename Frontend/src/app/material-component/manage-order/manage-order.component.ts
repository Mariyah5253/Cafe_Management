...
export class ManageOrderComponent implements OnInit {
  ...
  validateSubmit(){
    // if(
    //   this.totalAmount === 0 || this.manageOrderForm.controls['name'].value === null || 
    ...
    // if(
    //   this.total === 0 || this.manageOrderForm.controls['name'].value === null || 
    // this.manageOrderForm.controls['email'].value === null || this.manageOrderForm.controls['contactNumber'].value === null || 
    // this.manageOrderForm.controls['paymentMethod'].value === null ||
    // !(this.manageOrderForm.controls['contactNumber'].valid) || !(this.manageOrderForm.controls['email'].valid ))
    if(
...
add(){
  ...
  if(productName === undefined){
    ...
    quantity: formData.quantity, price: formData.price,total:formData.total, totalAmount:formData.totalAmount
    });
    this.dataSource  = [...this.dataSource];
    this.snackbarService.openSnackBar(AllConstantsValidation.productAdded,"success");
  }
  else{
    this.snackbarService.openSnackBar(AllConstantsValidation.productExistError, AllConstantsValidation.error);
  }
}
...
submitAction(){
  ...
  totalNumber = ele.total + totalNumber
 }​​)
